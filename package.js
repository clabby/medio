...
const electronCfg = require('./configs/webpack.config.electron');
const cfg = require('./configs/webpack.config.production');
...
const icon = argv.icon || argv.i || 'app/assets/images/icon';
